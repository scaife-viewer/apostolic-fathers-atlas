...
DATABASES = {
    "default": dj_database_url.config(
        default="postgres://localhost/apostolic_fathers_atlas"
    )
}
...
# Secret key
if DEBUG:
    SECRET_KEY = "vow+3-9vkjny9(xu#3nbg&y$14mdy+6_^i*9mkky+#y3g)e#&!"
else:
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "apostolic_fathers_atlas.context_processors.settings",
            ],
        },
    }
]
...
ROOT_URLCONF = "apostolic_fathers_atlas.urls"
